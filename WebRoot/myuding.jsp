<%@ page language="java" import="java.util.*,java.sql.*,com.vdong.db.*"
	pageEncoding="UTF-8"%>
<%
...
function calc() {
	...
	if(days>0){
	  var jine=count*days*price;
	   document.getElementById("fangkuan").value=jine*zhekou
	  
	  document.getElementById("dingjin").value=Math.ceil(jine*0.1)*zhekou;
	...
	<body>
		...
		<div class="page">
			<div class="page_con">
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											...
											<tr>
												...
												<td>
													...
													<input type="hidden" name="type"  id="type"  value="0.${type}"/>
											...
											<tr>
												...
												<td>
													<input type="text" name="tel" id="tel"
														class="text_input text150"  value="${user}"/>
				...
				<div class="bottom">
					<p>
						<a href="http://www.biyeseng.cn" style="color:white" target="_blank"></a>
					</p>
				</div>
				<!---------------页脚结束---------------->
			</div>
