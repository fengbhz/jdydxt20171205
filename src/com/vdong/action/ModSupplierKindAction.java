...
public class ModSupplierKindAction extends HttpServlet {

	public ModSupplierKindAction() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String sql = "update hotelsupplierkind set jiudianKind = '" + jiudianKind + "', jiudianOrder = '" + jiudianOrder + "', jiudianDate = str_to_date('" + jiudianDate+"','%Y-%m-%d') where id = '" + id + "'";
