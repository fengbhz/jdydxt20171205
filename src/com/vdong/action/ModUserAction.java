...
public class ModUserAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String role=request.getParameter("role");//会员等级
	 
		DBManager dbm = new DBManager();
		String sql = "update hoteluser set name='"+name+"',password='"+password+"',gender='"+gender+"',mobile='"+mobile+"',role='"+role+"' where id='"+id+"'";
