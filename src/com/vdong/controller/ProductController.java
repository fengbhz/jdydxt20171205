...
import com.vdong.util.AccountDate;
import com.vdong.util.Constants;
import com.vdong.util.DateUtil;
 ...
 */
	...
	@RequestMapping(value = { "product/HotelSearchByCatAction" },produces ={ "application/json; charset=utf-8"})
	@ResponseBody
	...
	@SuppressWarnings("unchecked")
	@RequestMapping(value = { "product/HotelSearchAction" },produces ={ "application/json; charset=utf-8"})
	@ResponseBody
	...
	@RequestMapping(value = {"product/list"},produces ={ "application/json; charset=utf-8"},  method = {org.springframework.web.bind.annotation.RequestMethod.POST})
	@ResponseBody
