...
import com.vdong.WechatHttp.HttpUtil;
import com.vdong.dao.OrderManagerDao;
...
public class OrderManagerServiceImpl implements OrderManagerService {
	...
	public Map<String,String> refundOrder(String id,String repayNum) {
		...
		if (null != list && list.size() > 0) {
			...
			if(null!=payWay&&payWay.equals("0")){//     直接返回，提示管理员直接现金退款
				remap.put("type", "0");
				remap.put("success", "true");
			}else if(null!=payWay&&payWay.equals("1")){ //  微信支付，调用微信支付退款接口
